...
//     quantity: 1,
//     image:
//       "https://images.pexels.com/photos/1385472/pexels-photo-1385472.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
//     size: "S",
//   },
// ];

export default function CartPage() {
  const { cartItems, removeFromCart, updateQuantity } = useCart(); // <-- USA EL CONTEXTO
              ...
              {cartItems.map((item) => (
                ...
                >
                  ...
                  <div className="flex-grow">
                    ...
                    <p className="font-semibold">€{item.list_price.toFixed(2)}</p>
                ...
                <Button
                  ...
                  onClick={() => {
                    toast({
                      ...
                      description:
                        "Redirigiendo a la pasarela de pago seguro...",
                    });
                  }}
                >
