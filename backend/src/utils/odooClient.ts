...
//     console.log("✅ Authentication successful with UID:", response.data.result);
...
// ): Promise<T> {
//   console.log(`📞 Calling Odoo: ${model}.${method}`, { args });
...
//     console.log(`✅ Odoo ${model}.${method} call successful`);
//     return response.data.result;
//   } catch (error: any) {
//     console.error(`❌ Error calling Odoo ${model}.${method}:`, error.message);
//     if (error.response) {
//       console.error("Response data:", error.response.data);
//     }
//     throw error;
